...
<body>
    ...
    <script>
        async function fetchNotifications() {
            ...
            try {
                const response = await fetch("/api/back/myNotifications", {
                    method: "GET",
                    headers: {
                ...
                data.message.forEach(notification => {
                    ...
                    <a href="/back/notification/${notification.id}" style="width: 80%; height: 20%; border: 2px solid purple;pedding:5%;">
